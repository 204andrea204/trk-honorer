...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <!-- Custom fonts for this template-->
    ...
    <body class="login-page" style="">
        @if(empty($q->foto2))
            <img src="{{asset('foto/tampilandashboard/sekolah.jpeg')}}" style="height: 100%;width: 100%; background-size: cover;">
         @else
            ...
            <div class="row">
                <div class="form-box col-md-8 col-sm-10 col-xs-12">
                    <div class="col-lg-7 col-md-6 col-sm-6 col-xs-12 univ-identity-box">
                        @if(empty($q->foto1))
                                <img src="{{asset('templatelogin/login/LogoSkiel.png')}}" style="height: 100%;width: 100%; background-size: cover;">
                                @else
